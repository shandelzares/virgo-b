...
public class MemberController {
    ...
    @PostMapping("v1/member/password/reset")
    public ResultData<?> resetPassword(@RequestBody MemberResetPasswordParam memberResetPasswordParam) {
        memberService.resetPassword( memberResetPasswordParam);
